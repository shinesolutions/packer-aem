...
mod 'shinesolutions/aem_curator', :git => 'https://github.com/hoomaan-kh/puppet-aem-curator.git', :branch => 'jdk11-and-ssl-include-both-java'
...
mod 'shinesolutions/aem_resources', :git => 'https://github.com/hoomaan-kh/puppet-aem-resources.git', :branch => 'jdk11-enable-granite-ssl'
