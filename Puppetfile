...
mod 'shinesolutions/aem_curator', :git => 'https://github.com/hoomaan-kh/puppet-aem-curator.git', :branch => 'hoomaan-jdk11-ssl-update'
...
mod 'shinesolutions/aem_resources', :git => 'https://github.com/hoomaan-kh/puppet-aem-resources.git', :branch => 'hoomaan-enable-ssl-by-deafault'
