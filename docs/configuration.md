...
| aem.author.jvm_opts | A list of AEM Author's [JVM arguments](https://docs.oracle.com/cd/E22289_01/html/821-1274/configuring-the-default-jvm-and-java-arguments.html). The following default jvm_opts are always set: '-XX:+PrintGCDetails', '-XX:+PrintGCTimeStamps', '-XX:+PrintGCDateStamps', '-XX:+PrintTenuringDistribution', '-XX:+PrintGCApplicationStoppedTime' & '-XX:+HeapDumpOnOutOfMemoryError'| Optional | |
...
| aem.publish.jvm_opts | A list of AEM Publish's [JVM arguments](https://docs.oracle.com/cd/E22289_01/html/821-1274/configuring-the-default-jvm-and-java-arguments.html). The following default jvm_opts are always set: '-XX:+PrintGCDetails', '-XX:+PrintGCTimeStamps', '-XX:+PrintGCDateStamps', '-XX:+PrintTenuringDistribution', '-XX:+PrintGCApplicationStoppedTime' & '-XX:+HeapDumpOnOutOfMemoryError' | Optional |
