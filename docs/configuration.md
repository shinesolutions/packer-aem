...
| aem.dispatcher.ssl_version | AEM Dispatcher SSL version, available version depends on what's provided by Adobe on [AEM Dispatcher Release Notes](https://docs.adobe.com/content/help/en/experience-manager-dispatcher/using/getting-started/release-notes.html#apache) page | Optional | `1.1` |
