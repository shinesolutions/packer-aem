...
* The `secretsmanager:GetSecretValue` permission is not required if using the S3 Bucket for storing the TLS key
* Add back `aws.aem_certs_base` configuration property
