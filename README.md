...
2. Run one of the convenient `make config-examples-<aem_version>-<os_type>` targets to prepare the configuration, for example, if you want to bake AEM 6.3 on RHEL7, run `make config-examples-aem63-rhel7`
3. Create the machine images `make <component> version=<version>`
