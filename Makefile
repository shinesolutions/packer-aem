...
packer_aem_version ?= 5.19.1-pre.0
...
ami-ids-examples: stage
	...
	$(call ami_ids_examples,aws-rhel8-aem64-jdk8)
	$(call ami_ids_examples,aws-rhel8-aem65-jdk8)
	$(call ami_ids_examples,aws-rhel8-aem65-jdk11)
